...
def usage():
    ...
    print "************************************************PICatTool**********************************************"
    print
    print "Developed by @PratikWhiteHat"
    print
    print "Usage PiCat.py -t target_host -p port"
    ...
    print
    print "Examples"
    print "picat.py -t 192.168.0.1 -p 5555 -l -c"
    print "picat.py -t 192.168.0.1 -p 5555 -l -u=C:\\target.exe"
    print "picat.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\""
    print "echo     'ABCDEFGH' | ./picat.py -t 192.168.11.12 -p 135"
    print
    sys.exit(0)
...
def main():
    ...
    if not listen and len(target)and port > 0:
        #read in the the buffer from the commandline
